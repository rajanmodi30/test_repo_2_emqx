...
-define(LOG(Level, Format, Args), emqx_logger:Level("test: " ++ Format, Args)).

register_metrics() ->
    [emqx_metrics:new(MetricName) || MetricName <- ['test.client_connected',
                                                    'test.client_disconnected',
                                                    'test.client_subscribe',
                                                    'test.client_unsubscribe',
                                                    'test.session_created',
                                                    'test.session_subscribed',
                                                    'test.session_unsubscribed',
                                                    'test.session_terminated',
                                                    'test.message_publish',
                                                    'test.message_deliver',
                                                    'test.message_acked']].
